...
/****************************************************************************** 
function:total insertion length all chrS and scaffoldS from lumpy_insertion_start_end_sequence.txt
...
string read_file_name="/home/2015525/lumpy/lumpy_insertion/lumpy_insertion_start_end_sequence.txt";//in ubuntu:input file path;if need,change your own file path
//in windows:string read_file_name="C:\\2015525\\lumpy\\lumpy_insertion\\lumpy_insertion_start_end_sequence.txt";

string write_file_name="/home/2015525/lumpy/lumpy_insertion/SV_length_total.txt";//in ubuntu:output file path;if need,change your own file path
//in windows:string write_file_name="C:\\2015525\\lumpy\\lumpy_insertion\\SV_length_total.txt";
...
int main(void)
{
	...
	vector <long long int > length_sv;
	...
	sort(length_sv.begin(),length_sv.end());
	
	for(long long int j=0;j<length_sv.size();j++)
	{
		
		write_file<<length_sv[j]<<endl;
	}
