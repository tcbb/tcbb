...
/****************************************************************************** 
function: PASA and delly share the number of inversions in hedou data. 
...
int main(void)
{
	...
	*/ 
	if((total_file=fopen("F://data//pd_total_inversion.txt","w+"))==NULL){
		puts("pd_total_inversion can not open.");
		exit(0);
	} 
	//extract file
	char line[1024];
