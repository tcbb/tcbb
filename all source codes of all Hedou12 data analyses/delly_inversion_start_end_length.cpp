...
/****************************************************************************** 
function:statistic start coordinates,end coordinates and inversion length from delly_inversion.vcf 
...
string read_file_name="/home/2015525/delly/delly_inversion/delly_inversion.vcf";//in ubuntu:input file path; if need, change your own file path
//in windows:string read_file_name="C:\\2015525\\delly\\delly_inversion\\delly_inversion.vcf";
string write_file_name="/home/2015525/delly/delly_inversion/delly_inversion_start_end_length.txt";//output file path;if need,change your own file path
//in windows:string write_file_name="C:\\2015525\\delly\\delly_inversion\\delly_inversion_start_end_length.txt";
