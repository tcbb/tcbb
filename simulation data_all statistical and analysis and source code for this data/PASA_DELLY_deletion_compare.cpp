...
/****************************************************************************** 
function:PASA and delly share the number of deletions in simulation data. 
...
int main(void)
{
	...
	*/ 
	if((total_file=fopen("F://data//pd_total_deletion.txt","w+"))==NULL){
		puts("pd_total_deletion can not open.");
		exit(0);
	} 
	//extract file
	char line[1024];
