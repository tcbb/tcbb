...
/****************************************************************************** 
function:PASA,delly and lumpy share the number of inverions in simulation data. 
...
int main(void)
{
	...
	*/
	if((pasa_data=fopen("F://data//simulation//pasa//inversion.txt","r"))==NULL){
	...
	if((lumpy_data=fopen("F://data//simulation//lumpy//inversion.txt","r"))==NULL){
	...
	if((total_file=fopen("F://data//pdl_total_inversion.txt","w+"))==NULL){
