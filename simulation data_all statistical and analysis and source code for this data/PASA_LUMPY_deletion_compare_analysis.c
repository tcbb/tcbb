...
/****************************************************************************** 
function:PASA and lumpy share the number of deletions in simulation data. 
...
int main(void)
{
	...
	*/ 
	if((total_file=fopen("F://data//pl_total_deletion.txt","w+"))==NULL){
		puts("pl_total_deletion can not open.");
		exit(0);
	} 
	//extract file
	char line[1024];
