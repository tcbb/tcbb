...
/****************************************************************************** 
function:extract start coordinates,end coordinates,insertion lengths and insertion sequence from lumpy_insertion.vcf
...
string read_file_name="/home/2015525/lumpy/lumpy_insertion/lumpy_insertion.vcf";//in ubuntu:input file path;if need,change your own file path
//in windows:string read_file_name="C:\\2015525\\lumpy\\lumpy_insertion\\lumpy_insertion.vcf";


string write_file_name="/home/2015525/lumpy/lumpy_insertion/lumpy_insertion_start_end_sequence.txt";//in ubuntu:output file path;if need,change your own file path
//in windows:string write_file_name="C:\\2015525\\lumpy\\lumpy_insertion\\lumpy_insertion_start_end_sequence.txt";
