...
/****************************************************************************** 
function:statistic start coordinates and end coordinates and deletion length from delly_deletion
running environment:ubuntu 14.0.2 server operating system or windows8 operating system
C compiler: GCC 4.7.4 or DEV-C++4.9.9.0
*************************************************************************/ 


string read_file_name="/home/2015525/delly/delly_deletion/delly_deletion.vcf";//in ubuntu:input file path;change your own file path
// in windows:string read_file_name="C:\\2015525\\delly\\delly_deletion\\delly_deletion.vcf";
string write_file_name="/home/2015525/delly/delly_deletion/delly_deletion_start_end_length.txt";//in ubuntu:output file path;change your own file path
//in windwos:string write_file_name="C:\\2015525\\delly\\delly_deletion\\delly_deletion_start_end_length.txt";
int main(void)
{
	ifstream read_file;
